...
namespace ColApp.Migrations
{
    ...
    [Migration("20250126041718_Fixage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ColApp.Models.PhotoEleve", b =>
                {
                    ...
                    b.ToTable("PhotoEleve", "db_accessadmin");
                });

            modelBuilder.Entity("ColApp.Models.TentativesConnexion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TentativesConnexion", "db_accessadmin");
                });
            ...
            modelBuilder.Entity("ColApp.Models.Utilisateur", b =>
                {
                    ...
                    b.Property<DateTime?>("EmailTokenExpiration")
                        .HasColumnType("datetime")
                        .HasColumnName("emailTokenExpiration");
            ...
            modelBuilder.Entity("ColApp.Models.PhotoEleve", b =>
                {
                    b.HasOne("ColApp.Models.Eleve", "IdEleveNavigation")
                        .WithMany("PhotoEleves")
                        .HasForeignKey("IdEleve")
                        .IsRequired()
                        .HasConstraintName("FK__PhotoElev__idEle__1E6F845E");

                    b.Navigation("IdEleveNavigation");
                });
